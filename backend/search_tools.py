...
class CourseSearchTool(Tool):
    ...
    def _format_results(self, results: SearchResults) -> str:
        ...
        for doc, meta in zip(results.documents, results.metadata):
            ...
            # Build source object with lesson link
            source = {
            ...
            if lesson_num is not None:
                ...
                if lesson_link:
                    source["lesson_link"] = lesson_link
...
class CourseOutlineTool(Tool):
    """Tool for retrieving complete course outlines with lesson information"""
    ...
    def get_tool_definition(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "description": "Get the complete outline of a course including title, course link, and all lessons with their titles and numbers",
            "input_schema": {
                "type": "object",
                "properties": {
                    "course_title": {
                        "type": "string",
                        "description": "Course title (partial matches work, e.g. 'MCP', 'Introduction', 'Building Toward Computer Use')",
                    }
                },
    ...
    def execute(self, course_title: str) -> str:
        ...
        # Get course metadata from the course_catalog
        try:
