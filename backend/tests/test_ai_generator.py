...
class TestSequentialToolCalling:
    ...
    def test_single_round_sufficient_no_additional_tools(self, ai_generator, mock_anthropic_client):
    ...
    def test_two_rounds_needed_sequential_tool_usage(self, ai_generator, mock_anthropic_client):
        ...
        mock_tool_manager.execute_tool.assert_called_once_with("get_course_outline", course_title="MCP")
    ...
    def test_no_loop_different_tool_params(self, rag_system):
        ...
        previous_calls = [{"name": "search_course_content", "input": {"query": "test2"}}]
    ...
    def test_final_response_synthesis_without_tools(self, ai_generator, mock_anthropic_client):
    ...
    @patch('rag_system.VectorStore')
    @patch('rag_system.SessionManager')
    def test_rag_system_sequential_execution_flow(self, mock_session, mock_vector, mock_doc, mock_config):
        ...
        rag_system.ai_generator.generate_response_with_tools.side_effect = [
            "Round 1 response", "Round 2 response"
        ]
    ...
    def test_max_rounds_enforcement(self, rag_system):
        ...
        rag_system.ai_generator.generate_response_with_tools = Mock(return_value="Round response")
        rag_system.ai_generator.generate_final_response = Mock(return_value="Final response")
        rag_system.ai_generator.last_used_tools = [{"name": "persistent_tool", "input": {}}]
    ...
    def test_conversation_history_preservation(self, ai_generator, mock_anthropic_client):
    ...
    def test_source_accumulation_across_rounds(self, rag_system):
        ...
        rag_system.ai_generator.generate_response_with_tools.side_effect = mock_tools_side_effect
