...
"""
    ...
    def generate_response_with_tools(
        ...
        # Handle tool execution if needed
        if response.stop_reason == "tool_use" and tool_manager:
            return self._handle_tool_execution_sequential(
    ...
    def _handle_tool_execution_sequential(
        self, initial_response, base_params: Dict, tool_manager
    ):
        """
    ...
    def generate_final_response(
        self, messages: List[Dict], conversation_history: Optional[str] = None
    ) -> str:
        """
